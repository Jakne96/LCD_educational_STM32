...
#define ST7735S_GAMCTRN1		0xe1 //Prześledzić sobie skąd się to wziąwszy, jednobajtowe komendy w dokumentacji
/*
 * BTW, zobaczyć sobie jak sie te komendy wrzuca, to może tak to zastosuje do potencjometru
 * Z tego co widze to dobrą praktyką jest włączanie peryferium i wyłączenie go od razu po wysłaniu komendy + danych
...
static const uint16_t init_table[] = {//Okej czyli to jest inicjalizacja i wysyłają komendy po kolei
